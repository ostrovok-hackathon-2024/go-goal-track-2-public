...
const char *WrapGetErrorString() { return GetErrorStringFn(); }

ModelCalcerHandle *WrapModelCalcerCreate() { return ModelCalcerCreateFn(); }
...
bool WrapCalcModelPredictionSingle(ModelCalcerHandle *modelHandle,
                                   ...
                                   size_t resultSize) {
  return CalcModelPredictionSingleFn(modelHandle, floatFeatures,
                                     floatFeaturesSize, catFeatures,
                                     catFeaturesSize, result, resultSize);
}
...
bool WrapCalcModelPrediction(ModelCalcerHandle *modelHandle, size_t docCount,
  ...
  return CalcModelPredictionFn(modelHandle, docCount, floatFeatures,
                               floatFeaturesSize, catFeatures, catFeaturesSize,
                               result, resultSize);
}
...
char ***makeCharArray2D(int size) { return calloc(sizeof(char **), size); }

char **makeCharArray1D(int size) { return calloc(sizeof(char *), size); }
...
void setCharArray1D(char **array, char *s, int n) { array[n] = s; }

void setCharArray2D(char ***a, char **s, int n) { a[n] = s; }

float **makeFloatArray2D(int size) { return calloc(sizeof(float *), size); }

void setFloatArray2D(float **a, float *f, int n) { a[n] = f; }